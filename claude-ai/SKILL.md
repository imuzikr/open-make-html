...
Guide the user through the full setup using the file contents below.
...
**Step 3.** GitHub Settings → Pages → Source: **GitHub Actions**

**Step 4.** GitHub Settings → Environments → github-pages → add **main** branch
