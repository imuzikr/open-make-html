...
.card{{
  ...
  color:inherit;display:flex;flex-direction:column;overflow:hidden;position:relative;
  box-shadow:var(--shadow-sm);transition:all 180ms ease;cursor:pointer;
}}
...
.card-dl{{
  ...
  transition:all 140ms ease;opacity:0;
}}
